...
*/
contract OffchainAggregator is /* Ownable, */ OffchainAggregatorBilling, AggregatorV2V3Interface, TypeAndVersionInterface {
  ...
  function expectedMsgDataLength(
    bytes memory _report, bytes32[] memory _rs, bytes32[] memory _ss
  ...
  function transmit(
    ...
    bytes32[] memory _rs, bytes32[] memory _ss, bytes32 _rawVs // signatures
  )
    internal
  {
    ...
    // zero tail.
    // TODO: update TRANSMIT_MSGDATA_CONSTANT_LENGTH_COMPONENT & expectedMsgDataLength
    // to be consistent with calls to verify()
